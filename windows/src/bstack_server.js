...
var prepareDeletePath = function(browser_data_location) {
	...
	//console.log("DeletePathPrepared :" + "\"" + browser_data_location + "\"")
	//return "\"" + browser_data_location + "\""
}
...
my_http.createServer(function(request, response) {
	...
	var mapping = JSON.parse(fs.readFileSync(global.project_root+"/windows/config/browser_mapper.json"))
